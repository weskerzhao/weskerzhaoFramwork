package com.waterbase.widget.glide;
...
public class GlideUpperHalfRoundTransform implements Transformation<Bitmap> {
    ...
    public GlideUpperHalfRoundTransform(Context context, float radius) {
