package com.waterbase.widget.pickerview;
...
import com.waterbase.widget.pickerview.listener.CustomListener;
import com.waterbase.widget.pickerview.view.BasePickerView;
import com.waterbase.widget.pickerview.view.WheelTime;
...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        if (customListener == null) {
            ...
            //设置文字
            btnSubmit.setText(TextUtils.isEmpty(Str_Submit) ? context.getResources().getString(R.string.ok) : Str_Submit);
            ...
            tvTitle.setTextColor(Color_Title == 0 ? pickerview_timebtn_nor : Color_Title);
