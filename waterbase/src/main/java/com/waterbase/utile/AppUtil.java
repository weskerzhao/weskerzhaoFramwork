...
import com.waterbase.bean.AppVersion;
...
public class AppUtil {
    ...
    public static AppVersion getVersion(Context context) {
        try {
            ...
            AppVersion appVersion = new AppVersion(versionCode, version);
            return appVersion;
        } catch (Exception e) {
            e.printStackTrace();
//            throw new NullPointerException("版本信息对象为空！");
            return null;
        }
    }
