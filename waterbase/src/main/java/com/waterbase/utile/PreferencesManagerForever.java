 ...
 */
public class PreferencesManagerForever {

    private final String tag = PreferencesManagerForever.class.getSimpleName();
    private Context mContext;
    private SharedPreferences preferences;
    // 默认系统SharedPreferences KEY值名称
    private static String shareName = AppConfig.isFirstInGuide;
    public static final String THEME = "Theme";
    public static final String LANG = "Lang";
    private static PreferencesManagerForever instance;
     ...
     * @param context
     */
    private PreferencesManagerForever(Context context) {
     ...
     * @param shareName
     */
    private PreferencesManagerForever(Context context, String shareName) {
        mContext = context;
        preferences = context.getSharedPreferences(shareName, Context.MODE_PRIVATE);
    }

    public static PreferencesManagerForever getInstance(Context context) {
        return getInstance(context, shareName);
    }

    public static PreferencesManagerForever getInstance(Context context, String shareName) {
        if (instance == null) {
            synchronized (PreferencesManagerForever.class) {
                if (instance == null) {
                    instance = new PreferencesManagerForever(context, shareName);
                }
            }
        }
        return instance;
    ...
    public <T> void setDataList(Context context, String tag, List<T> datalist) {
        PreferencesManagerForever instance = PreferencesManagerForever.getInstance(context);
